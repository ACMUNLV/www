...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="lg:mx-auto mx-4 my-20 max-w-[850px] flex-col items-center lg:items-start justify-between lg:flex-row-reverse">
        <div className="hidden lg:flex w-64 items-center flex-wrap justify-center gap-5 lg:w-96 lg:flex-col">
          {texts.aboutPage['why-join'].images.map((image, index) => (
              <Image
                ...
                width={image.width}
                height={image.height}
                className="max-w-[300px] w-auto rounded-md transition hover:scale-105"
              />
          ))}
        </div>
        <div className="space-y-4 text-center lg:text-left">
      ...
      <section className="mx-auto my-20 flex max-w-[850px] flex-col items-center lg:items-start justify-between lg:flex-row-reverse">
        <div className="flex shrink-0 flex-col items-center gap-4">
          ...
          />
          <a href="https://involvementcenter.unlv.edu/organization/unlv-acm" target="_blank" rel="noopener noreferrer" className="lg:mb-0 mb-6">
            <Button size="lg">Involvement Center</Button>
          </a>
        </div>
        <div className="space-y-4 text-center lg:text-left justify-start">
