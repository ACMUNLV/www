    ...
    <div>
      <div className="flex h-[375px] flex-col rounded-lg bg-white p-6 drop-shadow-xl">
        <div className="flex flex-col items-center justify-center space-y-3">
          ...
          <h3 className="font-dosis font-semibold text-neutral-900">{header}</h3>
          <p className="font-dosis flex-wrap text-center text-sm text-neutral-900">{description}</p>
        </div>
        <div className="mt-3 flex flex-grow flex-col items-center justify-end">
          <button
            ...
            className={cn(
              ...
              'text-sm font-medium leading-4 text-neutral-700 shadow-sm',
