...
strokeDasharray="500"
          style={{ animation: 'svg 3s ease-in-out 0.0s infinite' }}
        />
...
strokeDasharray="500"
        ...
        <path
          ...
          strokeDashoffset={500}
strokeDasharray="500"
          style={{ animation: 'svg 3s ease-in-out 0.3s infinite' }}
        />
...
strokeDasharray="500"
        ...
        <path
          ...
          strokeDashoffset={500}
strokeDasharray="500"
          style={{ animation: 'svg 3s ease-in-out 0.5s infinite' }}
        />
...
strokeDasharray="500"
        ...
        <path
          ...
          strokeDashoffset={500}
strokeDasharray="500"
          style={{ animation: 'svg 3s ease-in-out 0.8s infinite' }}
        />
...
strokeDasharray="500"
        ...
        <path
          ...
          strokeDashoffset={500}
strokeDasharray="500"
          style={{ animation: 'svg 3s ease-in-out 1.0s infinite' }}
        />
...
strokeDasharray="500"
        ...
        <path
          ...
          strokeDashoffset={500}
strokeDasharray="500"
          style={{ animation: 'svg 3s ease-in-out 1.3s infinite' }}
        />
        <path
